inherited formRecebimentoCreateEdit: TformRecebimentoCreateEdit
  AlphaBlend = True
  AlphaBlendValue = 250
  BorderStyle = bsNone
  Caption = 'formRecebimentoCreateEdit'
  ClientHeight = 740
  ClientWidth = 1024
  Color = 3618615
  ...
  object pnl_principal: TPanel
    ...
    object pnl_recebimento_header: TPanel
      Left = 21
      Top = 1
      Width = 976
      Height = 80
    ...
    object pnl_recebimento_footer: TPanel
      Left = 21
      Top = 639
      Width = 976
      Height = 80
    ...
    object pnl_recebimento_body: TPanel
      Left = 21
      Top = 83
      Width = 976
      Height = 554
      ...
      object pnl_left: TPanel
        ...
        object pnl_recebimento: TPanel
          ...
          object lbe_valor_recebido: TLabeledEdit
            Left = 480
            Top = 70
            Width = 150
            Height = 23
            ...
            EditLabel.Width = 82
            EditLabel.Height = 15
            EditLabel.Caption = 'Valor Recebido'
            ReadOnly = True
            TabOrder = 4
          end
          object dtp_recebimento: TDateTimePicker
            Left = 20
            Top = 70
            Width = 150
            Height = 23
  ...
  object acl_recebimento: TActionList
    Images = dmRepository.iml_32
    OnUpdate = acl_recebimentoUpdate
    Left = 624
    Top = 37
