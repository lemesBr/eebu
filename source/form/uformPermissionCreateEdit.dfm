inherited formPermissionCreateEdit: TformPermissionCreateEdit
  AlphaBlend = True
  AlphaBlendValue = 250
  BorderStyle = bsNone
  Caption = 'formPermissionCreateEdit'
  ClientHeight = 740
  ClientWidth = 1024
  Color = 3618615
  ...
  object pnl_body: TPanel
    ...
    object pnl_main: TPanel
      ...
      object lbe_permission: TLabeledEdit
        Tag = 1
        Left = 470
        Top = 32
        Width = 300
  ...
  object acl_permission: TActionList
    Images = dmRepository.iml_32
    Left = 408
    Top = 309
