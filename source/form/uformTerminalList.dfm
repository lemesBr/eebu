inherited formTerminalList: TformTerminalList
  AlphaBlend = True
  AlphaBlendValue = 250
  BorderStyle = bsNone
  Caption = 'formTerminalList'
  ClientHeight = 740
  ClientWidth = 1024
  Color = 3618615
  ...
  object pnl_principal: TPanel
    ...
    object pnl_body: TPanel
      ...
      object dbg_terminais: TDBGrid
        ...
        OnDrawColumnCell = dbg_terminaisDrawColumnCell
        Columns = <
          item
            Expanded = False
            FieldName = 'NOME'
  ...
  object fdmt_terminais: TFDMemTable
    ...
    Left = 331
    Top = 297
    object fdmt_terminaisID: TStringField
      FieldName = 'ID'
      Size = 32
    end
    object fdmt_terminaisAUTHENTICATION: TStringField
      FieldName = 'AUTHENTICATION'
      Size = 32
    end
    object fdmt_terminaisNOME: TStringField
      FieldName = 'NOME'
      Size = 255
    end
  end
  object ds_terminais: TDataSource
    DataSet = fdmt_terminais
    Left = 331
    Top = 353
  end
  ...
  object acl_terminais: TActionList
    Images = dmRepository.iml_32
    OnUpdate = acl_terminaisUpdate
    Left = 424
    Top = 355
