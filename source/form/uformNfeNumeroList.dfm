inherited formNfeNumeroList: TformNfeNumeroList
  AlphaBlend = True
  AlphaBlendValue = 250
  BorderStyle = bsNone
  Caption = 'formNfeNumeroList'
  ClientHeight = 740
  ClientWidth = 1024
  Color = 3618615
  ...
  object pnl_principal: TPanel
    ...
    object pnl_body: TPanel
      ...
      object dbg_nfe_numero: TDBGrid
        ...
        OnDrawColumnCell = dbg_nfe_numeroDrawColumnCell
        Columns = <
          item
            Expanded = False
            FieldName = 'MODELO'
  ...
  object acl_nfe_numero: TActionList
    Images = dmRepository.iml_32
    OnUpdate = acl_nfe_numeroUpdate
    Left = 456
    Top = 27
  ...
  object fdmt_nfe_numero: TFDMemTable
    ...
    Left = 331
    Top = 297
    object fdmt_nfe_numeroID: TStringField
      FieldName = 'ID'
      Size = 32
    end
    object fdmt_nfe_numeroMODELO: TIntegerField
      FieldName = 'MODELO'
    end
    object fdmt_nfe_numeroSERIE: TIntegerField
      FieldName = 'SERIE'
    end
    object fdmt_nfe_numeroNUMERO: TIntegerField
      FieldName = 'NUMERO'
    end
  end
  object ds_nfe_numero: TDataSource
    DataSet = fdmt_nfe_numero
    Left = 331
    Top = 353
  end
