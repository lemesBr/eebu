inherited formCompraOrcamentoList: TformCompraOrcamentoList
  AlphaBlend = True
  AlphaBlendValue = 250
  BorderStyle = bsNone
  Caption = 'formCompraOrcamentoList'
  ClientHeight = 740
  ClientWidth = 1024
  Color = 3618615
  ...
  object fdmt_orcamentos: TFDMemTable
    ...
    object fdmt_orcamentosUSER: TStringField
      FieldName = 'USER'
      Size = 255
    end
    object fdmt_orcamentosNFE_ID: TStringField
      FieldName = 'NFE_ID'
      Size = 32
    end
