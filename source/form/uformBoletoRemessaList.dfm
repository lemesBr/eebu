inherited formBoletoRemessaList: TformBoletoRemessaList
  AlphaBlend = True
  AlphaBlendValue = 250
  BorderStyle = bsNone
  Caption = 'formBoletoRemessaList'
  ClientHeight = 740
  ClientWidth = 1024
  Color = 3618615
  ...
  object pnl_principal: TPanel
    ...
    object pnl_remessa_header: TPanel
      Left = 21
      Top = 1
      Width = 976
      Height = 80
    ...
    object pnl_remessa_footer: TPanel
      Left = 21
      Top = 639
      Width = 976
      Height = 80
      ...
      ParentColor = True
      TabOrder = 1
      object btn_gerar_remessa: TButton
    ...
    object pnl_remessa_body: TPanel
      Left = 21
      Top = 83
      Width = 976
      Height = 554
  ...
  object fdmt_boletos: TFDMemTable
    ...
    object fdmt_boletosPROCESSAMENTO: TDateField
      FieldName = 'PROCESSAMENTO'
    ...
    object fdmt_boletosVENCIMENTO: TDateField
      FieldName = 'VENCIMENTO'
      DisplayFormat = 'dd/mm/yyyy'
    end
    object fdmt_boletosVALOR: TFloatField
      FieldName = 'VALOR'
      DisplayFormat = '###,##0.00'
    end
  end
  ...
  object acl_boletos: TActionList
    ...
    object act_gerar_remessa: TAction
      Caption = 'F5 - GERAR'
      ImageIndex = 6
      ShortCut = 116
      OnExecute = act_gerar_remessaExecute
    end
  end
