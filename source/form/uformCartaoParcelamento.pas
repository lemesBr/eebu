...
begin
  ...
  begin
    ...
    for I:= 1 to TAuthService.getAuthenticatedConfig.Parcelamento do
    begin
    ...
    0: begin
      ...
      begin
        ...
        TAuthService.listCtRecebimento.Last.ContaId:=
          TAuthService.getAuthenticatedConfig.VendaContaId;
        TAuthService.listCtRecebimento.Last.CategoriaId:=
          TAuthService.getAuthenticatedConfig.VendaCategoriaId;
