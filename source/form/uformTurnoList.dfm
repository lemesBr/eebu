inherited formTurnoList: TformTurnoList
  AlphaBlend = True
  AlphaBlendValue = 250
  BorderStyle = bsNone
  Caption = 'formTurnoList'
  ClientHeight = 740
  ClientWidth = 1024
  Color = 3618615
  ...
  object acl_turnos: TActionList
    Images = dmRepository.iml_32
    OnUpdate = acl_turnosUpdate
    Left = 424
    Top = 355
  ...
  object fdmt_turnos: TFDMemTable
    ...
    Left = 331
    Top = 297
    object fdmt_turnosID: TStringField
      FieldName = 'ID'
      Size = 32
    end
    object fdmt_turnosNOME: TStringField
      FieldName = 'NOME'
      Size = 255
    end
    object fdmt_turnosINICIO: TStringField
      FieldName = 'INICIO'
      Size = 255
    end
    object fdmt_turnosFIM: TStringField
      FieldName = 'FIM'
      Size = 255
    end
  end
